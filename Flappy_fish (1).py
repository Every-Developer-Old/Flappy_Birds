...
pass_pipe = False
Distance_pipe = 250
pipe_frequency = 2400 #milliseconds
...
ground_image = pygame.transform.scale(pygame.image.load('Assets/Background/floor.png'), (672, 224)).convert(Main_Screen)
restart_image = pygame.image.load('Assets/Buttons/restart.png').convert(Main_Screen)
...
class Bird_Animation(pygame.sprite.Sprite):
    ...
    def __init__(self, x, y):
        ...
        for index in range(0, 3):
            ...
            New_Bird = pygame.transform.scale2x(pygame.image.load(PLAYERS_LIST[Random_Player][index]))
    ...
    def update(self):
        ...
        if Fluttering:
            ...
            if self.rect.bottom <= (floor_height + 20):
...
class Pipe(pygame.sprite.Sprite):
    ...
    def __init__(self, x, y, Position):
        ...
        # My pipes
        self.image = pygame.transform.scale(pygame.image.load(PIPES_LIST[Random_Pipe]), (104, 640)).convert_alpha(Main_Screen)
        self.rect = self.image.get_rect()
...
Background_Page = pygame.transform.scale(pygame.image.load(BACKGROUNDS_LIST[Random_Page]), (576, 1024)).convert(Main_Screen)

# *__* *__* *__* *__* *__* *__* *__* Welcome Page *__* *__* *__* *__* *__* *__* *__* *__*
name_image = pygame.transform.scale2x(pygame.image.load('Assets/Message/bird_name.png'))
name_rect  = name_image.get_rect(center=(Screen_width/2, 200))

get_ready_Page = pygame.transform.scale2x(pygame.image.load('Assets/Message/get ready!.png'))
get_ready_rect = get_ready_Page.get_rect(center=(Screen_width/2, 380))

Tap_image = pygame.transform.scale2x(pygame.image.load('Assets/Message/tap.png'))
Tap_rect  = Tap_image.get_rect(center=(Screen_width/2, 650))
...
def Main_game(fly):
    ...
    while True:
        ...
        if Flappy_bird.rect.bottom >= (floor_height + 20):
