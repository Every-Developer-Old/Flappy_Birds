...
Icon = pygame.image.load('assets/Logo/Doge_icon2.png')
...
pg_rect = pg1_image.get_rect(center=((Screen_width/2+50), 400))
...
class Pipe(pygame.sprite.Sprite):
    ...
    def __init__(self, x, y, Position):
        ...
        # My pipes
        self.image = pygame.image.load('assets/Pipe/pipe_1.png').convert_alpha(Main_Screen)
        self.rect = self.image.get_rect()
...
get_ready_Page = pygame.image.load('assets/Message/get ready!.png').convert_alpha(Main_Screen)
...
def Welcome_Screen(Mode='Normal'):
    ...
    if Mode == 'Restart':
        ...
        get_ready_rect = get_ready_Page.get_rect(center=(Screen_width/2, 150))
        Tap_rect  = Tap_image.get_rect(center=(Screen_width/2, 320))
    
    elif Mode == 'Normal':
        get_ready_rect = get_ready_Page.get_rect(center=(Screen_width/2, 175))
...
def Counting_Score(Score, Color=Beige):
    ...
    Font_score = pygame.font.Font('assets/Font/Score.ttf', 42)
